        ...
        <div class="card mb-4">
         <!--  <img class="card-img-top" src="{{asset(Storage::disk('local')->url($post->image))}}" alt="Card image cap"> -->
          <div class="card-body">
            ...
            <a href="{{ route('essayenglish.show', $post->id) }}" class="btn btn-primary">Read More &rarr;</a>
          </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul class="list-unstyled mb-0">
                  ...
                  <li>
                    <h6><a href="{{url('/assignment')}}" style="text-decoration-line: none;">Assignment Paper</a>
                  </li></h6>
                  <li>
                    <a href="#">Freebies</a>
                  </li>
