		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<!-- form start -->
					<form action="{{route('essay.store')}}" method="POST" enctype="multipart/form-data">
						@csrf
						<div class="box-body">
							<div class="col-lg-6">
								...
								<div class="form-group">
									<label for="title">EnglishEssay Title</label>
									<input type="text" class="form-control" id="title" name="title" placeholder="EnglishEssay Title">
								</div>

								<div class="form-group">
									<div class="pull-right">
										<label for="image">Essay Photo</label>
