		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<!-- form start -->
					<form action="{{route('android.store')}}" method="POST" enctype="multipart/form-data">
						@csrf
						<div class="box-body">
							<div class="col-lg-6">
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Write Android Programming Description Here <small>Simple and fast</small></h3>
								<!-- tools box -->
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Write Android PROGRAMMING CODES Here <small>Simple and fast</small></h3>
								<!-- tools box -->
								<div class="pull-right box-tools">
									<button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
						...
						<div class="box-footer">
							...
							<a href="{{ route('android.index') }}" class="btn btn-warning">Back</a>
						</div>
					</form>
