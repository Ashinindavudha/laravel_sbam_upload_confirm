  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <a class=" col-lg-offset-8 btn btn-success" href="{{ route('research.create') }}" class="">Add New Research Post</a>
        @endcan
            ...
            <tbody>
              <tbody>
                ...
                <tr>
                  ...
                  @can('posts.update', Auth::user())
                  <td><a href="{{ route('research.edit', $research->id) }}"><span class="glyphicon glyphicon-edit"></a></span>
                    @endcan
                  </td>
                  @can('posts.delete', Auth::user())
                  <td>
