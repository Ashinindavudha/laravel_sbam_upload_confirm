					...
					<form action="{{route('advertise.update', $advertise->id)}}" method="POST" enctype="multipart/form-data">
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<div class="checkbox pull-left">
										<label>
											<input type="checkbox" name="status" value="1" @if ($advertise->status == 1) {{'checked'}} @endif> Publish
										</label>
									</div>
							</div>
							</div>
						...
						<div class="box">
							...
							<div class="box-body pad">
								...
								<textarea name="body" style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" id="editor1">{{ $advertise->body}}</textarea>
