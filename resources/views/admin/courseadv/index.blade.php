  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <a class=" col-lg-offset-8 btn btn-success" href="{{ route('advertise.create') }}" class="">Add New Advertise</a>
        @endcan
            ...
            <tbody>
              <tbody>
                ...
                <tr>
                  ...
                  @can('posts.update', Auth::user())
                  <td><a href="{{ route('advertise.edit', $advertise->id) }}"><span class="glyphicon glyphicon-edit"></a></span>
                    @endcan
                  </td>
                  @can('posts.delete', Auth::user())
                  <td>
                    <form id="delete-form-{{ $advertise->id }}" action="{{ route('advertise.destroy', $advertise->id) }}" style="display: none;" method="post">
                      @csrf
                      {{ method_field('DELETE') }}
