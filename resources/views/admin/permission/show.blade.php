  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <a class=" col-lg-offset-8 btn btn-success" href="{{ route('permission.create') }}" class="">Add New Permission</a>
            ...
            <tbody>
              <tbody>
                ...
                <tr>
                 ...
                 <td><a href="{{ route('permission.edit', $permission->id) }}"><span class="glyphicon glyphicon-edit"></a></span></td>
                  <td>
