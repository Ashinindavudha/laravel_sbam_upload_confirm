		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<!-- form start -->
					<form action="{{route('cplug.update', $computer->id)}}" method="POST" enctype="multipart/form-data">
						@csrf
						{{ method_field('PATCH') }}
						<div class="box-body">
							<div class="col-lg-6">
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Edit PHP Description Here <small>Simple and fast</small></h3>
								<!-- tools box -->
