						...
						<div class="box-body">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="name" name="name" placeholder="EnglishGrammar Author Name">
								</div>

								<div class="form-group">
									<label for="title">EnglishGrammar Post Title</label>
									<input type="text" class="form-control" id="title" name="title" placeholder="EnglishGrammar Post Title">
								</div>
